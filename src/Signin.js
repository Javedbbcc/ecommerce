                ...
                <div class="px-4 md:px-0 lg:w-6/12">
                  <div class="md:mx-6 md:p-12">
                    <div class="text-center">
                      <img class="mx-auto w-48" src="favicon.png" alt="logo" />
                      ...
                      <div class="relative mb-4" data-te-input-wrapper-init>
                        ...
                        {UserErr ? (
                          <span className="text-sm text-red-500">
                            User must contain 4 charecters
                          </span>
                        ) : (
                          ""
                        )}
                  ...
                  <div class="px-4 py-6 text-white md:mx-6 md:p-12">
                    ...
                    <div>
                      ...
                      <button
                        ...
                        className="px-6 mr-4 mt-8 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-lg shadow-[0_4px_9px_-4px_rgba(0,0,0,0.2)]"
                      >
                        SHOW
                      </button>
                      <button
